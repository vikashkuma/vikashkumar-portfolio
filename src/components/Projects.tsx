...
const Projects = () => {
  return (
    <section id="projects" className="py-20 sm:py-18 bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-blue-800 dark:text-blue-300">
